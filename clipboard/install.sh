#!/bin/bash
# Clipboard V 1.0
# coded by: github.com/KillgerHack/clipboard
...
printf " \e[1;92m coded by https://github.com/KillgerHack/clipboard\e[0m \n"
printf " \e[1;92m TELEGRAM: T.ME/KILLGERHACK\e[0m \n"
